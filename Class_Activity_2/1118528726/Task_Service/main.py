...
# Endpoint para retornar todas las tareas registradas 
...
#Enpoint para borrar una tarea por ID 
@service_b.route('/tasks/<int:id>', methods=['DELETE'])
def delete_task(id):
    ...
    if task:
        ...
        db.session.commit()
        return jsonify({'message': 'task delete correctly', 'id':taskid}), 200
