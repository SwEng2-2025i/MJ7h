...
class PDFReporter:
    ...
    def _get_next_filename(self, base_name="FrontEnd Tests Report"):
        ...
        # Verificar si existe el archivo base sin número
    ...
    def generate_charts(self):
        ...
        plt.title('Resultados Generales de Pruebas')
        ...
        plt.title('Resultados por Categoría')
        ...
        plt.xlabel('Tiempo')
        plt.ylabel('Número de Pruebas')
        plt.title('Progreso de Pruebas en el Tiempo')
        plt.legend()
        plt.xticks(rotation=45)
        
        plt.tight_layout()
        chart_path = 'test_results_chart.png'
    ...
    def generate_pdf_report(self):
        ...
        # Usar el nuevo sistema de nombres
...
def generate_test_report(results, start_time):
    reporter = PDFReporter(results, start_time)
